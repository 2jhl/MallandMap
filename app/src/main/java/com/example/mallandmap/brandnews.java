...
import android.widget.ImageButton;
    ...
    public class brandnews extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.brandnews);

            back = (ImageButton) findViewById(R.id.back_brandinfo);
